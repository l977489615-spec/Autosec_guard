...
{
        id: 'POC-NET-009', name: 'ADB Debug Port Detection',
...
{
        id: 'POC-NET-010', name: 'SSH Service Detection',
        category: Category.NETWORK, severity: Severity.MEDIUM, cvssScore: 5.0,
        pocFile: 'network/10_SSH_Service.py',
...
{
        id: 'POC-NET-011', name: 'SSH Weak Credentials',
        category: Category.NETWORK, severity: Severity.HIGH, cvssScore: 8.0,
        pocFile: 'network/11_SSH_Weak_Creds.py',
...
{
        id: 'POC-NET-012', name: 'SSH Hardcoded Credentials',
        category: Category.NETWORK, severity: Severity.CRITICAL, cvssScore: 9.8,
        pocFile: 'network/12_SSH_Hardcoded_Creds.py',
...
{
        id: 'POC-NET-013', name: 'Telnet Service Detection',
        category: Category.NETWORK, severity: Severity.HIGH, cvssScore: 7.5,
        pocFile: 'network/13_Telnet_Service.py',
...
Usage: python3 13_Telnet_Service.py <target_ip>
"""
import socket
import sys
from iv_plugin_base import IVIVulnerabilityPlugin
...
{
        id: 'POC-NET-014', name: 'Telnet Weak Credentials',
        category: Category.NETWORK, severity: Severity.CRITICAL, cvssScore: 9.8,
        pocFile: 'network/14_Telnet_Weak_Creds.py',
...
{
        id: 'POC-NET-015', name: 'FTP Anonymous Login',
        category: Category.NETWORK, severity: Severity.HIGH, cvssScore: 7.5,
        pocFile: 'network/15_FTP_Anonymous.py',
...
Usage: python3 15_FTP_Anonymous.py <target_ip>
"""
import socket
import sys
from iv_plugin_base import IVIVulnerabilityPlugin
...
{
        id: 'POC-NET-016', name: 'MQTT Unauthenticated Subscribe',
        category: Category.NETWORK, severity: Severity.HIGH, cvssScore: 7.0,
        pocFile: 'network/16_MQTT_Unauth.py',
...
Usage: python3 16_MQTT_Unauth.py <target_ip>
"""
import socket
import struct
import sys
...
{
        id: 'POC-NET-017', name: 'D-Bus Anonymous Authentication',
        category: Category.NETWORK, severity: Severity.CRITICAL, cvssScore: 9.0,
        cveId: 'CVE-2015-5611',
        pocFile: 'network/17_DBus_Anon_Auth.py',
...
{
        id: 'POC-NET-018', name: 'RTSP Log Information Leak',
        category: Category.NETWORK, severity: Severity.MEDIUM, cvssScore: 5.5,
        pocFile: 'network/18_RTSP_Log_Leak.py',
...
{
        id: 'POC-NET-019', name: 'DLNA AVTransport Unauth Control',
        category: Category.NETWORK, severity: Severity.MEDIUM, cvssScore: 6.0,
        pocFile: 'network/19_DLNA_AVTransport_Unauth.py',
...
{
        id: 'POC-NET-020', name: 'HTTPS Missing Certificate Pinning',
        category: Category.NETWORK, severity: Severity.MEDIUM, cvssScore: 5.5,
        pocFile: 'network/20_HTTPS_No_Cert_Pin.py',
    ...
    },
{
        ...
        cvssScore: 6.0,
        pocFile: 'network/21_SOMEIP_Service_Discovery.py',
...
class SOMEIPServiceDiscoveryPlugin(IVIVulnerabilityPlugin):
    ...
    Usage: python3 21_SOMEIP_Service_Discovery.py <target_ip>
"""
`,
    },
{
        id: 'POC-PROT-022', name: 'CAN Bus Traffic Capture',
        category: Category.CANBUS, severity: Severity.MEDIUM, cvssScore: 5.0,
        pocFile: 'canbus/22_CAN_Bus_Sniff.py',
...
{
        id: 'POC-PROT-023', name: 'CAN Message Injection',
        category: Category.CANBUS, severity: Severity.CRITICAL, cvssScore: 9.0,
        pocFile: 'canbus/23_CAN_Message_Injection.py',
...
{
        id: 'POC-PROT-024', name: 'CAN Bus DoS Flood',
        category: Category.CANBUS, severity: Severity.HIGH, cvssScore: 7.5,
        pocFile: 'canbus/24_CAN_DoS_Flood.py',
...
{
        id: 'POC-PROT-025', name: 'CAN Replay Attack',
        category: Category.CANBUS, severity: Severity.HIGH, cvssScore: 7.0,
        pocFile: 'canbus/25_CAN_Replay_Attack.py',
...
{
        id: 'POC-PROT-026', name: 'UDS Diagnostic Session Bypass',
        category: Category.CANBUS, severity: Severity.HIGH, cvssScore: 7.5,
        pocFile: 'canbus/26_UDS_DiagSession_Bypass.py',
...
{
        id: 'POC-PROT-027', name: 'UDS Security Access Brute Force',
        category: Category.CANBUS, severity: Severity.CRITICAL, cvssScore: 8.5,
        pocFile: 'canbus/27_UDS_Security_Access_Brute.py',
...
{
        id: 'POC-PROT-028', name: 'UDS ReadMemoryByAddress',
        category: Category.CANBUS, severity: Severity.CRITICAL, cvssScore: 8.5,
        pocFile: 'canbus/28_UDS_ReadMemory.py',
...
{
        id: 'POC-PROT-029', name: 'UDS RoutineControl Abuse',
        category: Category.CANBUS, severity: Severity.CRITICAL, cvssScore: 8.0,
        pocFile: 'canbus/29_UDS_RoutineControl.py',
...
{
        id: 'POC-PROT-030', name: 'OBD-II VIN Spoofing',
        category: Category.CANBUS, severity: Severity.MEDIUM, cvssScore: 5.0,
        pocFile: 'canbus/30_OBD_VIN_Spoof.py',
    ...
    },
{
        ...
        cvssScore: 7.5,
        pocFile: 'canbus/31_UDS_ECU_Reset_Unauth.py',
...
{
        id: 'POC-WIRELESS-032', name: 'QNX Qnet Unauthorized File Read',
        category: Category.WIRELESS, severity: Severity.CRITICAL, cvssScore: 9.1,
        cveId: 'CVE-2017-3891',
        pocFile: 'wireless/32_QNX_Qnet_File_Read.py',
...
Usage: python3 32_QNX_Qnet_File_Read.py <target_ip>
"""
import sys
import socket
from iv_plugin_base import IVIVulnerabilityPlugin
...
{
        id: 'POC-WIRELESS-033', name: 'WiFi Deauthentication Attack',
        category: Category.WIRELESS, severity: Severity.MEDIUM, cvssScore: 6.5,
        pocFile: 'wireless/33_WiFi_Deauth.py',
...
{
        id: 'POC-WIRELESS-034', name: 'WiFi Evil Twin AP',
        category: Category.WIRELESS, severity: Severity.HIGH, cvssScore: 7.0,
        pocFile: 'wireless/34_WiFi_Evil_Twin.py',
...
Usage: python3 34_WiFi_Evil_Twin.py <interface>
"""
import sys
import time
from iv_plugin_base import IVIVulnerabilityPlugin
...
{
        id: 'POC-WIRELESS-035', name: 'WPA2 KRACK Key Reinstallation',
        category: Category.WIRELESS, severity: Severity.HIGH, cvssScore: 6.8,
        cveId: 'CVE-2017-13077',
        pocFile: 'wireless/35_WiFi_KRACK.py',
...
Usage: python3 35_WiFi_KRACK.py <interface>
"""
import sys
import shutil
import subprocess
...
{
        id: 'POC-WIRELESS-036', name: 'TI WL18xx WiFi Driver Overflow',
        category: Category.WIRELESS, severity: Severity.CRITICAL, cvssScore: 9.6,
        cveId: 'CVE-2023-29468',
        pocFile: 'wireless/36_WiFi_TI_WL18xx_Overflow.py',
...
{
        id: 'POC-WIRELESS-037', name: 'ConnMan DHCP Buffer Overflow',
        category: Category.WIRELESS, severity: Severity.CRITICAL, cvssScore: 9.8,
        cveId: 'CVE-2021-26675',
        pocFile: 'wireless/37_ConnMan_DHCP_Overflow.py',
...
Usage: python3 37_ConnMan_DHCP_Overflow.py <interface>
"""
import sys
import time
from iv_plugin_base import IVIVulnerabilityPlugin
...
{
        id: 'POC-WIRELESS-038', name: 'Broadcom WME IE Overflow',
        category: Category.WIRELESS, severity: Severity.CRITICAL, cvssScore: 9.8,
        cveId: 'CVE-2017-9417',
        pocFile: 'wireless/38_Broadcom_WME_Overflow.py',
...
Prerequisites: 支持Monitor模式的无线网卡 (如 wlan0mon)，已安装 scapy。
Usage: python3 38_Broadcom_WME_Overflow.py <interface>
"""
import sys
import time
from iv_plugin_base import IVIVulnerabilityPlugin
...
{
        id: 'POC-WIRELESS-039', name: 'WiFi Unauthenticated Vehicle Control',
        category: Category.WIRELESS, severity: Severity.HIGH, cvssScore: 7.5,
        pocFile: 'wireless/39_WiFi_Unauth_Vehicle_Ctrl.py',
...
{
        id: 'POC-WIRELESS-040', name: 'Bluetooth HFP AT Command Overflow',
        category: Category.WIRELESS, severity: Severity.HIGH, cvssScore: 7.8,
        cveId: 'CVE-2025-32059',
        pocFile: 'wireless/40_BT_HFP_AT_Overflow.py',
...
{
        id: 'POC-WIRELESS-041', name: 'BLUFFS Session Key Downgrade',
        category: Category.WIRELESS, severity: Severity.HIGH, cvssScore: 6.8,
        cveId: 'CVE-2023-24023',
        pocFile: 'wireless/41_BT_BLUFFS_Key_Downgrade.py',
...
{
        id: 'POC-WIRELESS-042', name: 'BlueSDK L2CAP Null CID (PerfektBlue)',
        category: Category.WIRELESS, severity: Severity.CRITICAL, cvssScore: 8.8,
        cveId: 'CVE-2024-45431',
        pocFile: 'wireless/42_BT_PerfektBlue_L2CAP.py',
...
Usage: python3 42_BT_PerfektBlue_L2CAP.py <target_mac>
"""
import sys
import socket
import struct
...
{
        id: 'POC-WIRELESS-043', name: 'BlueSDK RFCOMM Confusion (PerfektBlue)',
        category: Category.WIRELESS, severity: Severity.HIGH, cvssScore: 7.5,
        cveId: 'CVE-2024-45432',
        pocFile: 'wireless/43_BT_PerfektBlue_RFCOMM.py',
...
Prerequisites: Linux蓝牙适配器, 目标设备运行BlueSDK栈。
Usage: python3 43_BT_PerfektBlue_RFCOMM.py <target_mac>
"""
import sys
import socket
from iv_plugin_base import IVIVulnerabilityPlugin
...
{
        id: 'POC-WIRELESS-044', name: 'Bluetooth HFP Use-After-Free',
        category: Category.WIRELESS, severity: Severity.CRITICAL, cvssScore: 9.0,
        cveId: 'CVE-2025-0084',
        pocFile: 'wireless/44_BT_HFP_UAF.py',
...
Usage: python3 44_BT_HFP_UAF.py <target_mac>
"""
import sys
import socket
from iv_plugin_base import IVIVulnerabilityPlugin
...
{
        id: 'POC-WIRELESS-045', name: 'Bluetooth Keystroke Injection',
        category: Category.WIRELESS, severity: Severity.HIGH, cvssScore: 7.5,
        cveId: 'CVE-2023-45866',
        pocFile: 'wireless/45_BT_Keystroke_Injection.py',
...
{
        id: 'POC-WIRELESS-046', name: 'BlueBorne BNEP Heap Overflow',
        category: Category.WIRELESS, severity: Severity.CRITICAL, cvssScore: 8.8,
        cveId: 'CVE-2017-0781',
        pocFile: 'wireless/46_BlueBorne_BNEP_Overflow.py',
...
{
        id: 'POC-WIRELESS-047', name: 'BleedingTooth L2CAP Type Confusion',
        category: Category.WIRELESS, severity: Severity.CRITICAL, cvssScore: 8.3,
        cveId: 'CVE-2020-12351',
        pocFile: 'wireless/47_BleedingTooth_L2CAP.py',
    ...
    },
{
        ...
        cvssScore: 8.0,
        cveId: 'CVE-2020-0022',
        pocFile: 'wireless/48_BT_CVE_2020_0022_DoS.py',
    ...
    },
{
        ...
        severity: Severity.MEDIUM,
        cvssScore: 6.5,
        pocFile: 'wireless/49_WiFi_SSID_Clone_AutoConnect.py',
...
{
        id: 'POC-APP-051', name: 'IVI USB Gadget SQL Injection',
        category: Category.APPLICATION, severity: Severity.HIGH, cvssScore: 6.8,
        cveId: 'CVE-2024-8355',
        pocFile: 'application/51_IVI_USB_SQLi.py',
...
{
        id: 'POC-APP-052', name: 'CarPlay Protocol Stack Overflow',
        category: Category.APPLICATION, severity: Severity.HIGH, cvssScore: 7.5,
        cveId: 'CVE-2024-23923',
        pocFile: 'application/52_CarPlay_Stack_Overflow.py',
...
{
        id: 'POC-APP-053', name: 'HiQnet Audio Protocol Stack Overflow',
        category: Category.APPLICATION, severity: Severity.CRITICAL, cvssScore: 9.8,
        cveId: 'CVE-2021-23906',
        pocFile: 'application/53_HiQnet_Stack_Overflow_TCP.py',
...
{
        id: 'POC-APP-054', name: 'HiQnet UDP Heap Overflow',
        category: Category.APPLICATION, severity: Severity.CRITICAL, cvssScore: 9.8,
        cveId: 'CVE-2021-23906',
        pocFile: 'application/54_HiQnet_Heap_Overflow_UDP.py',
...
Usage: python3 54_HiQnet_Heap_Overflow_UDP.py <target_ip>
"""
import sys
import socket
from iv_plugin_base import IVIVulnerabilityPlugin
...
{
        id: 'POC-APP-055', name: 'WebView file:// Data Exfiltration',
        category: Category.APPLICATION, severity: Severity.MEDIUM, cvssScore: 5.0,
        pocFile: 'application/55_WebView_File_Exfil.py',
...
Usage: python3 55_WebView_File_Exfil.py <bind_ip>
"""
import sys
import os
import time
...
{
        id: 'POC-APP-056', name: 'Filename Command Injection',
        category: Category.APPLICATION, severity: Severity.HIGH, cvssScore: 7.5,
        pocFile: 'application/56_Filename_Command_Injection.py',
...
{
        id: 'POC-APP-057', name: 'USB Path Traversal Injection',
        category: Category.APPLICATION, severity: Severity.CRITICAL, cvssScore: 8.5,
        pocFile: 'application/57_USB_Path_Injection.py',
...
{
        id: 'POC-APP-058', name: 'IVI Developer Mode Bypass',
        category: Category.APPLICATION, severity: Severity.CRITICAL, cvssScore: 8.5,
        cveId: 'CVE-2025-32063',
        pocFile: 'application/58_IVI_DevMode_Bypass.py',
...
Usage: python3 58_IVI_DevMode_Bypass.py <target_ip>
"""
import socket
import sys
import time
...
{
        id: 'POC-APP-059', name: 'Wireless Dongle Auth Bypass',
        category: Category.APPLICATION, severity: Severity.CRITICAL, cvssScore: 8.8,
        cveId: 'CVE-2025-2765',
        pocFile: 'application/59_Wireless_Dongle_Auth_Bypass.py',
    ...
    },
{
        ...
        pocFile: 'application/60_RTSP_CarPlay_DoS.py',
    ...
    },
{
        ...
        severity: Severity.HIGH,
        cvssScore: 7.5,
        pocFile: 'application/61_UPnP_AVTransport_Media_Inject.py',
...
{
        id: 'POC-APP-062', name: 'Mirror Hijack (UPnP)',
        category: Category.APPLICATION, severity: Severity.HIGH, cvssScore: 7.5,
        pocFile: 'application/62_Mirror_Hijack.py',
...
{
        id: 'POC-ADV-063', name: 'OTA Update MITM Interception',
        category: Category.ADVANCED, severity: Severity.CRITICAL, cvssScore: 8.5,
        pocFile: 'advanced/63_OTA_MITM_Interception.py',
...
{
        id: 'POC-ADV-065', name: 'GPS Signal Spoofing',
        category: Category.ADVANCED, severity: Severity.HIGH, cvssScore: 7.0,
        pocFile: 'advanced/65_GPS_Spoofing.py',
...
{
        id: 'POC-ADV-066', name: 'TPMS Signal Spoofing',
        category: Category.ADVANCED, severity: Severity.MEDIUM, cvssScore: 5.0,
        pocFile: 'advanced/66_TPMS_Signal_Spoofing.py',
...
{
        id: 'POC-ADV-067', name: 'V2X BSM Message Injection',
        category: Category.ADVANCED, severity: Severity.HIGH, cvssScore: 7.5,
        pocFile: 'advanced/67_V2X_BSM_Injection.py',
...
{
        id: 'POC-ADV-068', name: 'Firmware Update TOCTOU Race',
        category: Category.ADVANCED, severity: Severity.CRITICAL, cvssScore: 8.1,
        pocFile: 'advanced/68_FW_Update_TOCTOU.py',
...
Usage: python3 67_FW_Update_TOCTOU.py <target_update_dir>
"""
import sys
import os
import time
...
{
        id: 'POC-ADV-069', name: 'QNX Unsigned Firmware Image',
        category: Category.ADVANCED, severity: Severity.HIGH, cvssScore: 7.0,
        pocFile: 'advanced/69_QNX_Unsigned_Firmware.py',
...
Usage: python3 68_QNX_Unsigned_Firmware.py
"""
import sys
import os
from iv_plugin_base import IVIVulnerabilityPlugin
    ...
    },
{
        ...
        cvssScore: 9.8,
        cveId: 'N/A',
        pocFile: 'advanced/70_USB_Unsigned_Update.py',
