...
export const POC_DATABASE: POC[] = [
  ...
  },
  {
    ...
    pocFile: 'application/62_RTSP_CarPlay_DoS.py',
    ...
    requiredParams: ['ip'],
    codeSnippet: '# RTSP CarPlay DoS - CVE-2023-28898',
  },
  {
    id: 'POC-BT-009',
    ...
    cvssScore: 8.0,
    cveId: 'CVE-2020-0022',
    pocFile: 'wireless/63_BT_CVE_2020_0022_DoS.py',
    ...
    requiredParams: ['bluetooth_mac'],
    codeSnippet: '# BlueFrag BT L2CAP DoS - CVE-2020-0022',
  },
  {
    id: 'POC-APP-012',
    ...
    severity: Severity.HIGH,
    cvssScore: 7.5,
    pocFile: 'application/64_UPnP_AVTransport_Media_Inject.py',
    ...
    requiredParams: ['ip'],
    codeSnippet: '# UPnP AVTransport Media Inject DoS',
  },
  {
    id: 'POC-WIFI-009',
    ...
    cvssScore: 6.5,
    pocFile: 'wireless/65_WiFi_SSID_Clone_AutoConnect.py',
    ...
    requiredParams: ['interface'],
    codeSnippet: '# WiFi SSID Clone AutoConnect PoC',
  },
  {
    id: 'POC-NET-011',
    ...
    severity: Severity.MEDIUM,
    cvssScore: 6.0,
    pocFile: 'network/66_SOMEIP_Service_Discovery.py',
    ...
    requiredParams: ['ip'],
    codeSnippet: '# SOME/IP Service Discovery Info Leak',
  },
  {
    id: 'POC-PROT-011',
    ...
    severity: Severity.HIGH,
    cvssScore: 7.5,
    pocFile: 'canbus/67_UDS_ECU_Reset_Unauth.py',
    ...
    requiredParams: ['can_interface'],
    codeSnippet: '# UDS ECU Reset Unauthenticated',
  },
];
