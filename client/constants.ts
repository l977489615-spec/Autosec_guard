...
# ... (script truncated for display)`,
  },
  {
    ...
    category: Category.NETWORK, severity: Severity.CRITICAL, cvssScore: 9.8,
    pocFile: 'network/13_Telnet_Weak_Creds.py',
...
Description: 检测IVI系统Telnet服务弱口令。
Prerequisites: 目标Telnet端口(23)开放。
Usage: python3 13_Telnet_Weak_Creds.py <target_ip>
"""
import socket
import sys
import time
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'network/15_MQTT_Unauth.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    cveId: 'CVE-2015-5611',
    pocFile: 'network/16_DBus_Anon_Auth.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'network/17_RTSP_Log_Leak.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'network/18_DLNA_AVTransport_Unauth.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    category: Category.NETWORK, severity: Severity.MEDIUM, cvssScore: 5.5,
    pocFile: 'network/19_HTTPS_No_Cert_Pin.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'canbus/21_CAN_Bus_Sniff.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'canbus/22_CAN_Message_Injection.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'canbus/23_CAN_DoS_Flood.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'canbus/24_CAN_Replay_Attack.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    category: Category.CANBUS, severity: Severity.HIGH, cvssScore: 7.5,
    pocFile: 'canbus/25_UDS_DiagSession_Bypass.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'canbus/26_UDS_Security_Access_Brute.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    category: Category.CANBUS, severity: Severity.CRITICAL, cvssScore: 8.5,
    pocFile: 'canbus/27_UDS_ReadMemory.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'canbus/28_UDS_RoutineControl.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    category: Category.CANBUS, severity: Severity.MEDIUM, cvssScore: 5.0,
    pocFile: 'canbus/29_OBD_VIN_Spoof.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    cveId: 'CVE-2017-3891',
    pocFile: 'wireless/31_QNX_Qnet_File_Read.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'wireless/32_WiFi_Deauth.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'wireless/33_WiFi_Evil_Twin.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'wireless/34_WiFi_KRACK.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'wireless/35_WiFi_TI_WL18xx_Overflow.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'wireless/36_ConnMan_DHCP_Overflow.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    category: Category.WIRELESS, severity: Severity.CRITICAL, cvssScore: 9.8,
    cveId: 'CVE-2017-9417',
    pocFile: 'wireless/37_Broadcom_WME_Overflow.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'wireless/38_WiFi_Unauth_Vehicle_Ctrl.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'wireless/39_BT_HFP_AT_Overflow.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'wireless/40_BT_BLUFFS_Key_Downgrade.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'wireless/41_BT_PerfektBlue_L2CAP.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'wireless/42_BT_PerfektBlue_RFCOMM.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    cveId: 'CVE-2025-0084',
    pocFile: 'wireless/43_BT_HFP_UAF.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'wireless/44_BT_Keystroke_Injection.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    category: Category.WIRELESS, severity: Severity.CRITICAL, cvssScore: 8.8,
    cveId: 'CVE-2017-0781',
    pocFile: 'wireless/45_BlueBorne_BNEP_Overflow.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'wireless/46_BleedingTooth_L2CAP.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'application/49_AirPlay_AirBorne_UAF.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    cveId: 'CVE-2024-8355',
    pocFile: 'application/50_IVI_USB_SQLi.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'application/51_CarPlay_Stack_Overflow.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'application/52_HiQnet_Stack_Overflow_TCP.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    category: Category.APPLICATION, severity: Severity.CRITICAL, cvssScore: 9.8,
    cveId: 'CVE-2021-23906',
    pocFile: 'application/53_HiQnet_Heap_Overflow_UDP.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'application/54_WebView_File_Exfil.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    category: Category.APPLICATION, severity: Severity.HIGH, cvssScore: 7.5,
    pocFile: 'application/55_Filename_Command_Injection.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'application/56_USB_Path_Injection.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'application/57_IVI_DevMode_Bypass.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    cveId: 'CVE-2025-2765',
    pocFile: 'application/58_Wireless_Dongle_Auth_Bypass.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'advanced/61_OTA_MITM_Interception.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'advanced/62_RF_Keyfob_Replay.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'advanced/63_GPS_Spoofing.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'advanced/64_TPMS_Signal_Spoofing.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'advanced/65_V2X_BSM_Injection.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'advanced/66_FW_Update_TOCTOU.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    category: Category.ADVANCED, severity: Severity.HIGH, cvssScore: 7.0,
    pocFile: 'advanced/67_QNX_Unsigned_Firmware.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    cvssScore: 9.8,
    cveId: 'N/A',
    pocFile: 'advanced/68_USB_Unsigned_Update.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    pocFile: 'application/59_RTSP_CarPlay_DoS.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    cvssScore: 8.0,
    cveId: 'CVE-2020-0022',
    pocFile: 'wireless/47_BT_CVE_2020_0022_DoS.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    severity: Severity.HIGH,
    cvssScore: 7.5,
    pocFile: 'application/60_UPnP_AVTransport_Media_Inject.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    cvssScore: 6.5,
    pocFile: 'wireless/48_WiFi_SSID_Clone_AutoConnect.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    severity: Severity.MEDIUM,
    cvssScore: 6.0,
    pocFile: 'network/20_SOMEIP_Service_Discovery.py',
...
# ... (script truncated for display)`,
  },
  {
    ...
    severity: Severity.HIGH,
    cvssScore: 7.5,
    pocFile: 'canbus/30_UDS_ECU_Reset_Unauth.py',
