...
- `server/pocs/network/15_CWE_200_Service_Probe_Active_Validation.py`
...
The current `network/15_CWE_200_Service_Probe_Active_Validation.py` follows the standard plugin contract by defining `DynamicUnknownServiceProbePlugin(IVIVulnerabilityPlugin)`.
