...
NEW_POC_KNOWN: dict[str, dict[str, Any]] = {
    ...
    "poc43_bluetooth": {"protocol": "bluetooth", "severity": "Critical", "destructive_level": "Disruptive", "is_disruptive": True, "attack_surface": "无线/外设接口", "required_params": "bluetooth_mac", "profiles": ["bluetooth"]},
