#!/usr/bin/env python3
"""
PoC Name  : 检测设备是否存在Zygote进程命令注入漏洞（CVE-2024-31317）...
CVE       : CVE-2024-31317
Category  : advanced
Severity  : Critical
Type      : Type-A
Description: 检测设备是否存在Zygote进程命令注入漏洞（CVE-2024-31317）... vulnerability detection.
Prerequisites: See HW_REQUIREMENTS or VULN dict for details.
Usage     : python3 13_CVE_2024_31317_Android_Zygote_Command_Injection_Active_Validation.py <target_ip>
"""
...
class Poc40ZygotePlugin(IVIVulnerabilityPlugin):
    meta_display_id       = "POC-ADV-013"
    meta_poc_name = 'CVE-2024-31317 Android Zygote 命令注入 Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "13_Android_Zygote_Command_Injection_Audit") if "VULN" in dir() else "13_Android_Zygote_Command_Injection_Audit"
