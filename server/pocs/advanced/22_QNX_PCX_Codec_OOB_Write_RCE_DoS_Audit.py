...
def _write_qnx_pcx_oob_sample() -> str:
    ...
    return write_temp_sample("autosec_cve_2024_48856_", ".pcx", payload)


def _pcx_probe(plugin, vuln):
...
class Poc22CVE202448856OutOfBoundsRCEDoSAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name = 'CVE-2024-48856 越界写/RCE或DoS Active Validation'
    ...
    def exploit(self):
        return run_active_validation(self, VULN, probe=_pcx_probe)
