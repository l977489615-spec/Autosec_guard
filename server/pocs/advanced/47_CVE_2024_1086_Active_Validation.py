...
class Poc47CVE20241086NetfilterNftLpeAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2024-1086 nftables UAF Privilege Escalation Active Validation'
    ...
    meta_references       = ['https://github.com/Notselwyn/CVE-2024-1086']
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "47_Netfilter_NFT_LPE_Audit") if "VULN" in dir() else "47_Netfilter_NFT_LPE_Audit"
    ...
    _plugin = Poc47CVE20241086NetfilterNftLpeAuditPlugin({
