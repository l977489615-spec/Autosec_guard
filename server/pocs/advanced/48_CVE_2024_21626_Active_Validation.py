...
class Poc48CVE20241086RuncContainerEscapeAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2024-21626 fd into conta Active Validation'
    ...
    meta_references       = ['https://github.com/NitroCao/CVE-2024-21626']
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "48_Runc_Container_Escape_Audit") if "VULN" in dir() else "48_Runc_Container_Escape_Audit"
    ...
    _plugin = Poc48CVE20241086RuncContainerEscapeAuditPlugin({
