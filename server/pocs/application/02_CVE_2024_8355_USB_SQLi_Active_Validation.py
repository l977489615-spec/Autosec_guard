...
VULN = {
    ...
    "component":      "Unknown",
    "type":           "Unknown",
    "summary":        "IVI USB SQLi",
    "source_url":     "https://nvd.nist.gov/vuln/detail/CVE-2024-8355",
    "affected":       [{"vendor": "Unknown", "product": "Unknown", "versions": []}],
    "references":     ["https://nvd.nist.gov/vuln/detail/CVE-2024-8355"],
    "signature_tokens": ["CVE-2024-8355"],
}


def _run_poc(plugin, vuln=None) -> dict:
    """
    CVE-2024-8355 主动探针包装（兼容旧式 exploit() 实现）。
    ...
    evidence = {
        "cve":       vuln.get("cve", "CVE-2024-8355") if vuln else "CVE-2024-8355",
...
class IVIUsbSqliPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name = 'CVE-2024-8355 USB SQL注入 Active Validation'
