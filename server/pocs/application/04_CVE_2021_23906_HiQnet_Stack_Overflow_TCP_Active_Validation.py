...
Usage: python3 04_CVE_2021_23906_HiQnet_Stack_Overflow_TCP_Active_Validation.py <target_ip>
"""
...
VULN = {
    ...
    "component":      "Unknown",
    "type":           "Unknown",
    "summary":        "HiQnet Stack Overflow TCP",
...
class MercedesHiQnetPlugin(IVIVulnerabilityPlugin):
    ...
    目标端口: 3804 (TCP)
    """
    meta_poc_name = 'CVE-2021-23906 HiQnet 栈溢出 TCP Active Validation'
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 04_CVE_2021_23906_HiQnet_Stack_Overflow_TCP_Active_Validation.py <target_ip>")
        sys.exit(1)
