#!/usr/bin/env python3
"""
PoC Name  : 检测系统或app是否使用了不安全的libavformat.so库-v2（CVE-2016-1898）...
CVE       : CVE-2016-1898
Category  : application
Severity  : Critical
Type      : Type-A
Description: 检测系统或app是否使用了不安全的libavformat.so库-v2（CVE-2016-1898）... vulnerability detection.
Prerequisites: See HW_REQUIREMENTS or VULN dict for details.
Usage     : python3 27_CVE_2016_1898_LibAVFormat_Secondary_Version_Active_Validation.py <target_ip>
"""
...
class Poc22LibavformatExport2Plugin(IVIVulnerabilityPlugin):
    meta_display_id       = "POC-APP-027"
    meta_poc_name = 'CVE-2016-1898 LibAVFormat Secondary Version Active Validation'
    meta_cve_id = 'CVE-2016-1898'
    meta_source_url = 'https://nvd.nist.gov/vuln/detail/CVE-2016-1898'
    meta_references = ['https://nvd.nist.gov/vuln/detail/CVE-2016-1898']
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "27_LibAVFormat_Secondary_Version_Audit") if "VULN" in dir() else "27_LibAVFormat_Secondary_Version_Audit"
    ...
    _plugin = Poc22LibavformatExport2Plugin({
