#!/usr/bin/env python3
"""
PoC Name  : 检测系统或app是否使用了不安全的openssl（CVE-2016_6309）...
CVE       : CVE-2016-6309
Category  : application
Severity  : High
Type      : Type-A
Description: 检测系统或app是否使用了不安全的openssl（CVE-2016_6309）... vulnerability detection.
Prerequisites: See HW_REQUIREMENTS or VULN dict for details.
Usage     : python3 29_CVE_2016_6309_OpenSSL_Version_Active_Validation.py <target_ip>
"""
...
class Poc24OpensslExportPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name = 'CVE-2016-6309 OpenSSL Version Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "29_OpenSSL_Version_Audit") if "VULN" in dir() else "29_OpenSSL_Version_Audit"
    ...
    _plugin = Poc24OpensslExportPlugin({
