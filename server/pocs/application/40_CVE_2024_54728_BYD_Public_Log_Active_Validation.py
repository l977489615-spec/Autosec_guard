#!/usr/bin/env python3
"""
PoC Name  : 检测设备是否存在系统日志泄露漏洞（CVE-2024-54728）...
CVE       : CVE-2024-54728
Category  : application
Severity  : Low
Type      : Type-A
Description: 检测设备是否存在系统日志泄露漏洞（CVE-2024-54728）... vulnerability detection.
Prerequisites: See HW_REQUIREMENTS or VULN dict for details.
Usage     : python3 40_CVE_2024_54728_BYD_Public_Log_Active_Validation.py <target_ip>
"""
...
class Poc35BydlogPlugin(IVIVulnerabilityPlugin):
    meta_display_id       = "POC-APP-040"
    meta_poc_name = 'CVE-2024-54728 BYD Public Log Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "40_BYD_Public_Log_Exposure_Audit") if "VULN" in dir() else "40_BYD_Public_Log_Exposure_Audit"
