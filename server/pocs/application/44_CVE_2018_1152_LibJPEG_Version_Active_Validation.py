#!/usr/bin/env python3
"""
PoC Name  : 检测系统或app是否使用了不安全的libjpeg-turbo.so库（CVE-2018-1152）...
CVE       : CVE-2018-1152
Category  : application
Severity  : High
Type      : Type-A
Description: 检测系统或app是否使用了不安全的libjpeg-turbo.so库（CVE-2018-1152）... vulnerability detection.
Prerequisites: See HW_REQUIREMENTS or VULN dict for details.
Usage     : python3 44_CVE_2018_1152_LibJPEG_Version_Active_Validation.py <target_ip>
"""
...
class Poc45LibjepgExportedPlugin(IVIVulnerabilityPlugin):
    meta_display_id       = "POC-APP-044"
    meta_poc_name = 'CVE-2018-1152 LibJPEG Version Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "44_LibJPEG_Version_Audit") if "VULN" in dir() else "44_LibJPEG_Version_Audit"
    ...
    _plugin = Poc45LibjepgExportedPlugin({
