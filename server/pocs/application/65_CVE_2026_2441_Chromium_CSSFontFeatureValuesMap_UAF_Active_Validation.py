...
def _run_poc(plugin, vuln=None) -> dict:
    """
    CVE-2026-2441 主动探针包装（兼容旧式 exploit() 实现）。
    ...
    evidence = {
        "cve":       vuln.get("cve", "CVE-2026-2441") if vuln else "CVE-2026-2441",
...
class ChromiumCSSFontFeatureValuesMapUAFAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name = 'CVE-2026-2441 Chromium CSSFontFeatureValuesMap UAF Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "65_Chromium_CSSFontFeatureValuesMap_UAF_Audit") if "VULN" in dir() else "65_Chromium_CSSFontFeatureValuesMap_UAF_Audit"
    ...
    _plugin = ChromiumCSSFontFeatureValuesMapUAFAuditPlugin({
