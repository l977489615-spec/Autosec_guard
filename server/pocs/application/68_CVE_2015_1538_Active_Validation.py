...
class Poc68CVE20151538StagefrightstscHeapOverflowRceAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2015-1538 Android Stagefright stsc 堆溢出 RCE Active Validation'
    ...
    meta_references       = ['https://github.com/Fuzion24/cve-2015-1538-2']
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "68_Android_libstagefright_Android_libstagefright_MP4_stsc_atom_Audit") if "VULN" in dir() else "68_Android_libstagefright_Android_libstagefright_MP4_stsc_atom_Audit"
    ...
    _plugin = Poc68CVE20151538StagefrightstscHeapOverflowRceAuditPlugin({
