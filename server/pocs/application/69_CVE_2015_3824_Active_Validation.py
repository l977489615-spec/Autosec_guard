...
class Poc69CVE20153824StagefrighttX3gHeapOverflowRceAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2015-3824 Android Stagefright tx3g 堆溢出 RCE Active Validation'
    ...
    meta_references       = ['https://github.com/jduck/cve-2015-3824']
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "69_Android_libstagefright_Android_libstagefright_MP4_tx3g_atom_Audit") if "VULN" in dir() else "69_Android_libstagefright_Android_libstagefright_MP4_tx3g_atom_Audit"
    ...
    _plugin = Poc69CVE20153824StagefrighttX3gHeapOverflowRceAuditPlugin({
