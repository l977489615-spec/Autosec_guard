...
class Poc71CVE20156620AMessageUnmarshalHeapOverflowRceAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2015-6620 Android AMessage unmarshal 堆溢出 RCE Active Validation'
    ...
    meta_references       = ['https://github.com/flankerhqd/CVE-2015-6620-POC']
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "71_Android_mediaserver_AMessage_Android_mediaserver_AMessage_unmarshal_Audit") if "VULN" in dir() else "71_Android_mediaserver_AMessage_Android_mediaserver_AMessage_unmarshal_Audit"
    ...
    _plugin = Poc71CVE20156620AMessageUnmarshalHeapOverflowRceAuditPlugin({
