...
class Poc73CVE20260006ApvCodecHeapOverflowRceAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2026-0006 Android libopenapv APV Codec 堆溢出 RCE Active Validation'
    ...
    meta_references       = ['https://github.com/mobilehackinglab/CVE-2026-0006-openapv-poc']
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "73_Android_libopenapv_media_codec_Android_libopenapv_media_Audit") if "VULN" in dir() else "73_Android_libopenapv_media_codec_Android_libopenapv_media_Audit"
    ...
    _plugin = Poc73CVE20260006ApvCodecHeapOverflowRceAuditPlugin({
