#!/usr/bin/env python3
"""
PoC Name  : 检测设备是否存在CAN流量劫持漏洞（CVE-2025-28169）...
CVE       : CVE-2025-28169
Category  : canbus
Severity  : High
Type      : Type-A
Description: 检测设备是否存在CAN流量劫持漏洞（CVE-2025-28169）... vulnerability detection.
Prerequisites: See HW_REQUIREMENTS or VULN dict for details.
Usage     : python3 11_CVE_2025_28169_CAN_Traffic_Hijack_Active_Validation.py <target_ip>
"""
...
class Poc36BydtrafficHijackPlugin(IVIVulnerabilityPlugin):
    meta_display_id       = "POC-CAN-011"
    meta_poc_name = 'CVE-2025-28169 CAN 流量劫持 Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "11_BYD_CAN_Traffic_Hijack_Audit") if "VULN" in dir() else "11_BYD_CAN_Traffic_Hijack_Audit"
    ...
    _plugin = Poc36BydtrafficHijackPlugin({
