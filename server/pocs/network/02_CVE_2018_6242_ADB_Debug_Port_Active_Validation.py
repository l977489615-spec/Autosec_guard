...
Usage: python3 02_CVE_2018_6242_ADB_Debug_Port_Active_Validation.py <target_ip>
"""
...
VULN = {
    ...
    "component":      "Unknown",
    "type":           "Unknown",
    "summary":        "Network ADB Debug Port Detection",
    "source_url":     "https://nvd.nist.gov/vuln/detail/CVE-2018-6242",
    "affected":       [{"vendor": "Unknown", "product": "Unknown", "versions": []}],
    "references":     ["https://nvd.nist.gov/vuln/detail/CVE-2018-6242"],
    "signature_tokens": ["CVE-2018-6242"],
}


def _run_poc(plugin, vuln=None) -> dict:
    """
    CVE-2018-6242 主动探针包装（兼容旧式 exploit() 实现）。
    ...
    evidence = {
        "cve":       vuln.get("cve", "CVE-2018-6242") if vuln else "CVE-2018-6242",
...
class ADBDebugPortPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name = 'CVE-2018-6242 ADB Debug Port Active Validation'
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 02_CVE_2018_6242_ADB_Debug_Port_Active_Validation.py <target_ip>")
        sys.exit(1)
