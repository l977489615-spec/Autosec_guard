...
class Poc68CVE202242005PersistenceLogShellAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2022-42005 Log Shell Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "68_Tesla_Model_3_Y_infotainment_MCU_Tesla_Audit") if "VULN" in dir() else "68_Tesla_Model_3_Y_infotainment_MCU_Tesla_Audit"
    ...
    _plugin = Poc68CVE202242005PersistenceLogShellAuditPlugin({
