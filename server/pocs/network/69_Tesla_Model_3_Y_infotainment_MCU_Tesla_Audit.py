...
Safety gate: is_disruptive=False for read-only subscription; True for injection.
...
class Poc69CVE202242006PrototypeServerUnauthWsAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = "CVE-2022-42006 Tesla prototype_server Unauthenticated WebSocket"
