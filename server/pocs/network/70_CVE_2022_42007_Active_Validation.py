...
class Poc70CVE202242007OdinNtpExpiredTokenReplayAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2022-42007 Tesla ODIN NTP 伪造 Expired Token 重放 Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "70_Tesla_Model_3_Y_infotainment_MCU_Tesla_Audit") if "VULN" in dir() else "70_Tesla_Model_3_Y_infotainment_MCU_Tesla_Audit"
    ...
    _plugin = Poc70CVE202242007OdinNtpExpiredTokenReplayAuditPlugin({
