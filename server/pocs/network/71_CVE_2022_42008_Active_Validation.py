...
class Poc71CVE202242008OdinCommandInjectionRceAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2022-42008 Tesla ODIN 命令注入 RCE Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "71_Tesla_Model_3_Y_infotainment_MCU_Tesla_Audit") if "VULN" in dir() else "71_Tesla_Model_3_Y_infotainment_MCU_Tesla_Audit"
    ...
    _plugin = Poc71CVE202242008OdinCommandInjectionRceAuditPlugin({
