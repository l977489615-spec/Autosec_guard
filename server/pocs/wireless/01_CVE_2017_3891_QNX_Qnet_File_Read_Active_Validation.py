...
VULN = {
    ...
    "component":      "Unknown",
    "type":           "Unknown",
    "summary":        "QNX Qnet File Read",
    "source_url":     "https://nvd.nist.gov/vuln/detail/CVE-2017-3891",
    "affected":       [{"vendor": "Unknown", "product": "Unknown", "versions": []}],
    "references":     ["https://nvd.nist.gov/vuln/detail/CVE-2017-3891"],
    "signature_tokens": ["CVE-2017-3891"],
}


def _run_poc(plugin, vuln=None) -> dict:
    """
    CVE-2017-3891 主动探针包装（兼容旧式 exploit() 实现）。
    ...
    evidence = {
        "cve":       vuln.get("cve", "CVE-2017-3891") if vuln else "CVE-2017-3891",
...
class QNXQconnReadPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name = 'CVE-2017-3891 QNX Qnet File Read Active Validation'
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 01_CVE_2017_3891_QNX_Qnet_File_Read_Active_Validation.py <target_ip>")
        sys.exit(1)
