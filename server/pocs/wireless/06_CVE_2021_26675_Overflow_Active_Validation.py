...
VULN = {
    ...
    "component":      "Unknown",
    "type":           "Unknown",
    "summary":        "ConnMan DHCP Overflow",
    "source_url":     "https://nvd.nist.gov/vuln/detail/CVE-2021-26675",
    "affected":       [{"vendor": "Unknown", "product": "Unknown", "versions": []}],
    "references":     ["https://nvd.nist.gov/vuln/detail/CVE-2021-26675"],
    "signature_tokens": ["CVE-2021-26675"],
}


def _run_poc(plugin, vuln=None) -> dict:
    """
    CVE-2021-26675 主动探针包装（兼容旧式 exploit() 实现）。
    ...
    evidence = {
        "cve":       vuln.get("cve", "CVE-2021-26675") if vuln else "CVE-2021-26675",
...
class ConnManDHCPOKPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name = 'CVE-2021-26675 Overflow Active Validation'
    meta_cve_id = "CVE-2021-26675"
    meta_source_url = "https://nvd.nist.gov/vuln/detail/CVE-2021-26675"
    meta_references = ['https://nvd.nist.gov/vuln/detail/CVE-2021-26675']
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 06_CVE_2021_26675_Overflow_Active_Validation.py <interface>")
        sys.exit(1)
