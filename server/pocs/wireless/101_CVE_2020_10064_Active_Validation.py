#!/usr/bin/env python3
"""CVE-2020-10064 – SweynTooth BLE: LLID Deadlock – BLE SoC LLID field deadlock in link layer.

Public PoC source: https://github.com/Matheus-Garbelini/sweyntooth_bluetooth_low_energy_attacks
  Script: llid_dealock.py
...
Usage:
  python llid_dealock.py /dev/ttyACM0 <target_bdaddr>
"""
...
VULN = {
    ...
    "summary": "LLID Deadlock – BLE SoC LLID field deadlock in link layer",
...
SWEYN_SCRIPT = SWEYN_REPO / "llid_dealock.py"
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "attack_surface": "BLE SoC LLID field 0b11 in data PDU → link layer deadlock",
    }
...
class Poc101CVE202010064SweynToothBleAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50_more"
    meta_display_id = "POC-WIRELESS-101"
    meta_poc_name   = 'CVE-2020-10064 SweynTooth LLID Deadlock Active Validation'
    meta_cve_id     = "CVE-2020-10064"
    meta_severity   = "High"
    ...
    meta_attack_surface = "BLE SoC LLID field 0b11 in data PDU → link layer deadlock"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "101_LLID_Deadlock__BLE_SoC_LLID_field_deadl_Audit") if "VULN" in dir() else "101_LLID_Deadlock__BLE_SoC_LLID_field_deadl_Audit"
    ...
    _plugin = Poc101CVE202010064SweynToothBleAuditPlugin({
