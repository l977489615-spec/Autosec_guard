#!/usr/bin/env python3
"""CVE-2021-28135 – BrakTooth BT Classic: Feature Response Flooding – ESP32 BT Classic crash via repeated feature_res.
...
VULN = {
    ...
    "summary": "Feature Response Flooding – ESP32 BT Classic crash via repeated feature_res",
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "attack_surface": "ESP32 BT Classic chip feature_response_flooding → reboot/DoS",
    }
...
class Poc102CVE202128135BrakToothBtClassicAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50_more"
    meta_display_id = "POC-WIRELESS-102"
    meta_poc_name   = 'CVE-2021-28135 BrakTooth ESP32 Feature Response Flooding Active Validation'
    meta_cve_id     = "CVE-2021-28135"
    meta_severity   = "High"
    ...
    meta_attack_surface = "ESP32 BT Classic chip feature_response_flooding → reboot/DoS"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "102_Feature_Response_Flooding__ESP32_BT_Cla_Audit") if "VULN" in dir() else "102_Feature_Response_Flooding__ESP32_BT_Cla_Audit"
    ...
    _plugin = Poc102CVE202128135BrakToothBtClassicAuditPlugin({
