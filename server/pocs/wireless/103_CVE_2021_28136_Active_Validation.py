...
class Poc103CVE202128136BrakToothBtClassicAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2021-28136 BrakTooth ESP32 Duplicated IOCAP Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "103_Duplicated_IOCAP__ESP32_BT_Classic_cras_Audit") if "VULN" in dir() else "103_Duplicated_IOCAP__ESP32_BT_Classic_cras_Audit"
    ...
    _plugin = Poc103CVE202128136BrakToothBtClassicAuditPlugin({
