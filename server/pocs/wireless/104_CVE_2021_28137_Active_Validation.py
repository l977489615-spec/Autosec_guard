...
class Poc104CVE202128137BrakToothBtClassicAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2021-28137 BrakTooth ESP32 Feature Ping-Pong Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "104_Feature_Request_Ping-Pong__ESP32_BT_Cla_Audit") if "VULN" in dir() else "104_Feature_Request_Ping-Pong__ESP32_BT_Cla_Audit"
    ...
    _plugin = Poc104CVE202128137BrakToothBtClassicAuditPlugin({
