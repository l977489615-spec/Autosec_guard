...
class Poc105CVE202128138BrakToothBtClassicAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2021-28138 BrakTooth ESP32 Invalid Payload Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "105_Wrong_Encapsulated_Payload__ESP32_BT_Cl_Audit") if "VULN" in dir() else "105_Wrong_Encapsulated_Payload__ESP32_BT_Cl_Audit"
    ...
    _plugin = Poc105CVE202128138BrakToothBtClassicAuditPlugin({
