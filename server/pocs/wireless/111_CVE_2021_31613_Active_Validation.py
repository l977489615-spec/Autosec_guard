...
class Poc111CVE202131613BrakToothBtClassicAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2021-31613 BrakTooth AC6905X Truncated LMP Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "111_Truncated_LMP_accepted__Jieli_AC6905X_c_Audit") if "VULN" in dir() else "111_Truncated_LMP_accepted__Jieli_AC6905X_c_Audit"
    ...
    _plugin = Poc111CVE202131613BrakToothBtClassicAuditPlugin({
