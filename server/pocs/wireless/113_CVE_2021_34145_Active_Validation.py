...
class Poc113CVE202134145BrakToothBtClassicAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2021-34145 BrakTooth CYW20735B1 Invalid Max Slot Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "113_LMP_Invalid_Max_Slot__Infineon_CYW20735_Audit") if "VULN" in dir() else "113_LMP_Invalid_Max_Slot__Infineon_CYW20735_Audit"
    ...
    _plugin = Poc113CVE202134145BrakToothBtClassicAuditPlugin({
