#!/usr/bin/env python3
"""CVE-2021-34146 – BrakTooth BT Classic: AU Rand Flooding – Infineon CYW20735B1 AU random flooding.
...
VULN = {
    ...
    "summary": "AU Rand Flooding – Infineon CYW20735B1 AU random flooding",
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "attack_surface": "Infineon CYW20735B1 BT SoC AU rand flooding → crash/reboot",
    }
...
class Poc114CVE202134146BrakToothBtClassicAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50_more"
    meta_display_id = "POC-WIRELESS-114"
    meta_poc_name   = 'CVE-2021-34146 BrakTooth CYW20735B1 AU RAND Flooding Active Validation'
    meta_cve_id     = "CVE-2021-34146"
    meta_severity   = "High"
    ...
    meta_attack_surface = "Infineon CYW20735B1 BT SoC AU rand flooding → crash/reboot"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "114_AU_Rand_Flooding__Infineon_CYW20735B1_A_Audit") if "VULN" in dir() else "114_AU_Rand_Flooding__Infineon_CYW20735B1_A_Audit"
    ...
    _plugin = Poc114CVE202134146BrakToothBtClassicAuditPlugin({
