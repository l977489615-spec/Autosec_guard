...
VULN = {
    ...
    "component":      "Unknown",
    "type":           "Unknown",
    "summary":        "BleedingTooth L2CAP",
    "source_url":     "https://nvd.nist.gov/vuln/detail/CVE-2020-12351",
    "affected":       [{"vendor": "Unknown", "product": "Unknown", "versions": []}],
    "references":     ["https://nvd.nist.gov/vuln/detail/CVE-2020-12351"],
    "signature_tokens": ["CVE-2020-12351"],
}


def _run_poc(plugin, vuln=None) -> dict:
    """
    CVE-2020-12351 主动探针包装（兼容旧式 exploit() 实现）。
    ...
    evidence = {
        "cve":       vuln.get("cve", "CVE-2020-12351") if vuln else "CVE-2020-12351",
...
class BleedingToothPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name = 'CVE-2020-12351 BleedingTooth L2CAP Active Validation'
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 16_CVE_2020_12351_BleedingTooth_L2CAP_Active_Validation.py <bluetooth_mac>")
        sys.exit(1)
