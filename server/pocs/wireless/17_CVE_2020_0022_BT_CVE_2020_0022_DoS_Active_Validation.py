...
Usage: python3 17_CVE_2020_0022_BT_CVE_2020_0022_DoS_Active_Validation.py <args>
"""
...
VULN = {
    ...
    "component":      "Unknown",
    "type":           "Unknown",
    "summary":        "BT CVE 2020 0022 DoS",
    "source_url":     "https://nvd.nist.gov/vuln/detail/CVE-2020-0022",
    "affected":       [{"vendor": "Unknown", "product": "Unknown", "versions": []}],
    "references":     ["https://nvd.nist.gov/vuln/detail/CVE-2020-0022"],
    "signature_tokens": ["CVE-2020-0022"],
}


def _run_poc(plugin, vuln=None) -> dict:
    """
    CVE-2020-0022 主动探针包装（兼容旧式 exploit() 实现）。
    ...
    evidence = {
        "cve":       vuln.get("cve", "CVE-2020-0022") if vuln else "CVE-2020-0022",
...
class BlueFrag2020DoSPlugin(IVIVulnerabilityPlugin):
    meta_display_id = "POC-WIRELESS-017"
    """
    ...
    安全性: 蓝牙自动恢复，不会造成持久损坏。
    """
    meta_poc_name = 'CVE-2020-0022 BT DoS Active Validation'
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 17_CVE_2020_0022_BT_CVE_2020_0022_DoS_Active_Validation.py <args>")
        sys.exit(1)
