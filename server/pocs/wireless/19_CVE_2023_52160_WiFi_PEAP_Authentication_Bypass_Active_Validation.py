...
Usage: python3 19_CVE_2023_52160_WiFi_PEAP_Authentication_Bypass_Active_Validation.py <interface> [config_path]
"""
...
class WiFiPEAPAuthBypassAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name = 'CVE-2023-52160 WiFi PEAP 认证绕过 Active Validation'
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 19_CVE_2023_52160_WiFi_PEAP_Authentication_Bypass_Active_Validation.py <interface> [config_path]")
        raise SystemExit(1)
