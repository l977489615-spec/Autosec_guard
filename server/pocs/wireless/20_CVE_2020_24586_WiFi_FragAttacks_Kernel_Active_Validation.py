...
Usage: python3 20_CVE_2020_24586_WiFi_FragAttacks_Kernel_Active_Validation.py <interface> [kernel_version]
"""
...
class WiFiFragAttacksKernelAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name = 'CVE-2020-24586 WiFi FragAttacks Kernel Active Validation'
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 20_CVE_2020_24586_WiFi_FragAttacks_Kernel_Active_Validation.py <interface> [kernel_version]")
        raise SystemExit(1)
