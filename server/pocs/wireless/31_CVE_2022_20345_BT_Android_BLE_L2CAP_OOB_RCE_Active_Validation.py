...
VULN = {
    ...
    "component":      "Unknown",
    "type":           "Unknown",
    "summary":        "BT Android BLE L2CAP OOB RCE Audit",
    "source_url":     "https://nvd.nist.gov/vuln/detail/CVE-2022-20345",
    "affected":       [{"vendor": "Unknown", "product": "Unknown", "versions": []}],
    "references":     ["https://nvd.nist.gov/vuln/detail/CVE-2022-20345"],
    "signature_tokens": ["CVE-2022-20345"],
}


def _run_poc(plugin, vuln=None) -> dict:
    """
    CVE-2022-20345 主动探针包装（兼容旧式 exploit() 实现）。
    ...
    evidence = {
        "cve":       vuln.get("cve", "CVE-2022-20345") if vuln else "CVE-2022-20345",
...
class BTAndroidBLEL2CAPOOBRCEAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name = 'CVE-2022-20345 BT Android BLE L2CAP 越界 RCE Active Validation'
