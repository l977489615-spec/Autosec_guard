...
VULN = {
    ...
    "component":      "Unknown",
    "type":           "Unknown",
    "summary":        "BT Android HFP SDP UAF RCE Audit",
    "source_url":     "https://nvd.nist.gov/vuln/detail/CVE-2023-21108",
    "affected":       [{"vendor": "Unknown", "product": "Unknown", "versions": []}],
    "references":     ["https://nvd.nist.gov/vuln/detail/CVE-2023-21108"],
    "signature_tokens": ["CVE-2023-21108"],
}


def _run_poc(plugin, vuln=None) -> dict:
    """
    CVE-2023-21108 主动探针包装（兼容旧式 exploit() 实现）。
    ...
    evidence = {
        "cve":       vuln.get("cve", "CVE-2023-21108") if vuln else "CVE-2023-21108",
...
class BTAndroidHFPSDPUAFRCEAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name = 'CVE-2023-21108 BT Android HFP SDP UAF RCE Active Validation'
