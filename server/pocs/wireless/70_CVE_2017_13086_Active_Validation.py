#!/usr/bin/env python3
"""CVE-2017-13086 – KRACK WPA2 key reinstallation: TDLS PeerKey reinstall (KRI attack).

Public PoC source: https://github.com/vanhoefm/krackattacks-scripts
  krack-test-client.py (TDLS variant)
...
VULN = {
    ...
    "summary": "TDLS PeerKey reinstall (KRI attack)",
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "attack_surface": "TDLS teardown/setup replay causes TPKSA deletion + PTK reinstall",
    }
    ...
    return {
        ...
        "evidence": evidence,
        "requires_manual_review": True,
        "poc_source": "vanhoefm/krackattacks-scripts / krack-test-client.py (TDLS variant)",
    }
...
class Poc70Cve201713086KrackKeyReinstallAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50"
    meta_display_id = "POC-WIRELESS-070"
    meta_poc_name   = 'CVE-2017-13086 KRACK Fourway Key Reinstallation Active Validation'
    meta_cve_id     = "CVE-2017-13086"
    meta_severity   = "High"
    meta_protocol   = "wifi"
    ...
    meta_attack_surface = "TDLS teardown/setup replay causes TPKSA deletion + PTK reinstall"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "70_wpa_supplicant_hostapd_WPA2_clients_APs_802_Audit") if "VULN" in dir() else "70_wpa_supplicant_hostapd_WPA2_clients_APs_802_Audit"
    ...
    _plugin = Poc70Cve201713086KrackKeyReinstallAuditPlugin({
