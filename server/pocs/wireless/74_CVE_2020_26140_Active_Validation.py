#!/usr/bin/env python3
"""CVE-2020-26140 – FragAttacks: Plaintext data frame injection during 4-way HS.

Public PoC source: https://github.com/vanhoefm/fragattacks
  research/fragattack.py (Mathy Vanhoef, 2020)
  Command: fragattack.py --inject-plaintext
...
VULN = {
    ...
    "summary": "Plaintext data frame injection during 4-way HS",
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "cmd_hint": "fragattack.py --inject-plaintext",
    }
...
class Poc74Cve202026140FragAttacksInjectionAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50"
    meta_display_id = "POC-WIRELESS-074"
    meta_poc_name   = 'CVE-2020-26140 FragAttacks Plaintext Frame Injection Active Validation'
    meta_cve_id     = "CVE-2020-26140"
    meta_severity   = "High"
    meta_protocol   = "wifi"
    ...
    meta_attack_surface = "Plaintext data frames accepted by AP/client during 4-way handshake"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "74_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit") if "VULN" in dir() else "74_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit"
    ...
    _plugin = Poc74Cve202026140FragAttacksInjectionAuditPlugin({
