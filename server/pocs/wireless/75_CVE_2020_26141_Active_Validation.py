#!/usr/bin/env python3
"""CVE-2020-26141 – FragAttacks: TKIP MIC failure bypass via fragmented frames.

Public PoC source: https://github.com/vanhoefm/fragattacks
  research/fragattack.py (Mathy Vanhoef, 2020)
  Command: fragattack.py --tkip-mic-bypass
...
VULN = {
    ...
    "summary": "TKIP MIC failure bypass via fragmented frames",
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "cmd_hint": "fragattack.py --tkip-mic-bypass",
    }
...
class Poc75Cve202026141FragAttacksInjectionAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50"
    meta_display_id = "POC-WIRELESS-075"
    meta_poc_name   = 'CVE-2020-26141 FragAttacks TKIP MIC Bypass Active Validation'
    meta_cve_id     = "CVE-2020-26141"
    meta_severity   = "High"
    meta_protocol   = "wifi"
    ...
    meta_attack_surface = "TKIP MIC check bypassed for fragmented frames allowing injection"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "75_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit") if "VULN" in dir() else "75_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit"
    ...
    _plugin = Poc75Cve202026141FragAttacksInjectionAuditPlugin({
