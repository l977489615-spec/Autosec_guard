#!/usr/bin/env python3
"""CVE-2020-26142 – FragAttacks: Fragmented frames reassembled across security contexts.

Public PoC source: https://github.com/vanhoefm/fragattacks
  research/fragattack.py (Mathy Vanhoef, 2020)
  Command: fragattack.py --frag-cache-poison
...
VULN = {
    ...
    "summary": "Fragmented frames reassembled across security contexts",
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "cmd_hint": "fragattack.py --frag-cache-poison",
    }
...
class Poc76Cve202026142FragAttacksInjectionAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50"
    meta_display_id = "POC-WIRELESS-076"
    meta_poc_name   = 'CVE-2020-26142 FragAttacks Cross-Context Reassembly Active Validation'
    meta_cve_id     = "CVE-2020-26142"
    meta_severity   = "High"
    meta_protocol   = "wifi"
    ...
    meta_attack_surface = "Fragment cache poisoning across security context boundaries"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "76_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit") if "VULN" in dir() else "76_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit"
    ...
    _plugin = Poc76Cve202026142FragAttacksInjectionAuditPlugin({
