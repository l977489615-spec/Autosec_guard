#!/usr/bin/env python3
"""CVE-2020-26143 – FragAttacks: Fragmented plaintext frames accepted after connection.

Public PoC source: https://github.com/vanhoefm/fragattacks
  research/fragattack.py (Mathy Vanhoef, 2020)
  Command: fragattack.py --frag-inject-after-connect
...
VULN = {
    ...
    "summary": "Fragmented plaintext frames accepted after connection",
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "cmd_hint": "fragattack.py --frag-inject-after-connect",
    }
...
class Poc77Cve202026143FragAttacksInjectionAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50"
    meta_display_id = "POC-WIRELESS-077"
    meta_poc_name   = 'CVE-2020-26143 FragAttacks Plaintext Fragment Acceptance Active Validation'
    meta_cve_id     = "CVE-2020-26143"
    meta_severity   = "High"
    meta_protocol   = "wifi"
    ...
    meta_attack_surface = "Plaintext fragment injected and reassembled after WPA2 connection"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "77_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit") if "VULN" in dir() else "77_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit"
    ...
    _plugin = Poc77Cve202026143FragAttacksInjectionAuditPlugin({
