#!/usr/bin/env python3
"""CVE-2020-26144 – FragAttacks: EtherType 0x888E (EAPOL) A-MSDU frame bypass.

Public PoC source: https://github.com/vanhoefm/fragattacks
  research/fragattack.py (Mathy Vanhoef, 2020)
  Command: fragattack.py --msdu-eapol-bypass
...
VULN = {
    ...
    "summary": "EtherType 0x888E (EAPOL) A-MSDU frame bypass",
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "cmd_hint": "fragattack.py --msdu-eapol-bypass",
    }
...
class Poc78Cve202026144FragAttacksInjectionAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50"
    meta_display_id = "POC-WIRELESS-078"
    meta_poc_name   = 'CVE-2020-26144 FragAttacks EAPOL A-MSDU Bypass Active Validation'
    meta_cve_id     = "CVE-2020-26144"
    meta_severity   = "High"
    meta_protocol   = "wifi"
    ...
    meta_attack_surface = "A-MSDU with EtherType 0x888E accepted by AP bypassing authentication"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "78_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit") if "VULN" in dir() else "78_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit"
    ...
    _plugin = Poc78Cve202026144FragAttacksInjectionAuditPlugin({
