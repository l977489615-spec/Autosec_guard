...
class Poc79Cve202026145FragAttacksInjectionAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2020-26145 FragAttacks Broadcast Fragment Decryption Bypass Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "79_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit") if "VULN" in dir() else "79_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit"
    ...
    _plugin = Poc79Cve202026145FragAttacksInjectionAuditPlugin({
