#!/usr/bin/env python3
"""CVE-2020-26146 – FragAttacks: Encrypted fragments reassembled with non-consecutive PN.

Public PoC source: https://github.com/vanhoefm/fragattacks
  research/fragattack.py (Mathy Vanhoef, 2020)
  Command: fragattack.py --non-consecutive-pn
...
VULN = {
    ...
    "summary": "Encrypted fragments reassembled with non-consecutive PN",
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "cmd_hint": "fragattack.py --non-consecutive-pn",
    }
...
class Poc80Cve202026146FragAttacksInjectionAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50"
    meta_display_id = "POC-WIRELESS-080"
    meta_poc_name   = 'CVE-2020-26146 FragAttacks Non-Consecutive PN Reassembly Active Validation'
    meta_cve_id     = "CVE-2020-26146"
    meta_severity   = "High"
    meta_protocol   = "wifi"
    ...
    meta_attack_surface = "Non-consecutive packet numbers in fragments accepted → replay injection"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "80_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit") if "VULN" in dir() else "80_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit"
    ...
    _plugin = Poc80Cve202026146FragAttacksInjectionAuditPlugin({
