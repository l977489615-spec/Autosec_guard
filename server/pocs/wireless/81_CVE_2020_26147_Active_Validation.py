#!/usr/bin/env python3
"""CVE-2020-26147 – FragAttacks: Mixed encrypted/plaintext fragment reassembly.

Public PoC source: https://github.com/vanhoefm/fragattacks
  research/fragattack.py (Mathy Vanhoef, 2020)
  Command: fragattack.py --mixed-key-attack
...
VULN = {
    ...
    "summary": "Mixed encrypted/plaintext fragment reassembly",
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "cmd_hint": "fragattack.py --mixed-key-attack",
    }
...
class Poc81Cve202026147FragAttacksInjectionAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50"
    meta_display_id = "POC-WIRELESS-081"
    meta_poc_name   = 'CVE-2020-26147 明文 fragment reassembly Active Validation'
    meta_cve_id     = "CVE-2020-26147"
    meta_severity   = "High"
    meta_protocol   = "wifi"
    ...
    meta_attack_surface = "Mixed encrypted+plaintext fragments reassembled enabling controlled injection"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "81_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit") if "VULN" in dir() else "81_Poc_802_11_Wi_Fi_implementations_Fragmentation_Aggregation_Audit"
    ...
    _plugin = Poc81Cve202026147FragAttacksInjectionAuditPlugin({
