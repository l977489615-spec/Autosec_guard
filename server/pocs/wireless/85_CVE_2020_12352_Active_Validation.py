...
class Poc85CVE202012352BleedingToothA2mpHeapLeakAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2020-12352 BleedingTooth A2MP Heap 信息泄露 Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "85_Linux_kernel_Bluetooth_BlueZ_Bluetooth_L2CAP_A2MP_Audit") if "VULN" in dir() else "85_Linux_kernel_Bluetooth_BlueZ_Bluetooth_L2CAP_A2MP_Audit"
    ...
    _plugin = Poc85CVE202012352BleedingToothA2mpHeapLeakAuditPlugin({
