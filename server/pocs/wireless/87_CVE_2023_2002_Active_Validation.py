...
class Poc87CVE20232002HciMgmtPrivEscAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2023-2002 Linux Bluetooth HCI MGMT 权限提升 Active Validation'
    ...
    meta_references       = ['https://github.com/lrh2000/CVE-2023-2002']
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "87_Linux_kernel_Bluetooth_HCI_Bluetooth_HCI_mgmt_Audit") if "VULN" in dir() else "87_Linux_kernel_Bluetooth_HCI_Bluetooth_HCI_mgmt_Audit"
    ...
    _plugin = Poc87CVE20232002HciMgmtPrivEscAuditPlugin({
