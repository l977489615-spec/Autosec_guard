...
class Poc90CVE201916336SweynToothBleAuditPlugin(IVIVulnerabilityPlugin):
    ...
    meta_poc_name   = 'CVE-2019-16336 BLE Oversized LL PDU Crash Active Validation'
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "90_Link_Layer_Length_Overflow__Cypress_NXP_Audit") if "VULN" in dir() else "90_Link_Layer_Length_Overflow__Cypress_NXP_Audit"
    ...
    _plugin = Poc90CVE201916336SweynToothBleAuditPlugin({
