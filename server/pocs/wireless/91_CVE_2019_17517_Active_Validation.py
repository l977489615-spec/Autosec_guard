#!/usr/bin/env python3
"""CVE-2019-17517 – SweynTooth BLE: Truncated L2CAP – Dialog DA14580 ATT crash via truncated L2CAP fragment.

Public PoC source: https://github.com/Matheus-Garbelini/sweyntooth_bluetooth_low_energy_attacks
  Script: DA14580_exploit_att_crash.py
...
Usage:
  python DA14580_exploit_att_crash.py /dev/ttyACM0 <target_bdaddr>
"""
...
VULN = {
    ...
    "summary": "Truncated L2CAP – Dialog DA14580 ATT crash via truncated L2CAP fragment",
...
SWEYN_SCRIPT = SWEYN_REPO / "DA14580_exploit_att_crash.py"
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "attack_surface": "Dialog DA14580 BLE SoC truncated L2CAP fragment → ATT crash",
    }
...
class Poc91CVE201917517SweynToothBleAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50_more"
    meta_display_id = "POC-WIRELESS-091"
    meta_poc_name   = 'CVE-2019-17517 SweynTooth Dialog DA14580 Truncated L2CAP Active Validation'
    meta_cve_id     = "CVE-2019-17517"
    meta_severity   = "High"
    ...
    meta_attack_surface = "Dialog DA14580 BLE SoC truncated L2CAP fragment → ATT crash"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "91_Truncated_L2CAP__Dialog_DA14580_ATT_cra_Audit") if "VULN" in dir() else "91_Truncated_L2CAP__Dialog_DA14580_ATT_cra_Audit"
    ...
    _plugin = Poc91CVE201917517SweynToothBleAuditPlugin({
