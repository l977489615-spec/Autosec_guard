#!/usr/bin/env python3
"""CVE-2019-19193 – SweynTooth BLE: Invalid Connection Request – TI CC2640 BLE connection request crash.

Public PoC source: https://github.com/Matheus-Garbelini/sweyntooth_bluetooth_low_energy_attacks
  Script: CC_connection_req_crash.py
...
Usage:
  python CC_connection_req_crash.py /dev/ttyACM0 <target_bdaddr>
"""
...
VULN = {
    ...
    "summary": "Invalid Connection Request – TI CC2640 BLE connection request crash",
...
SWEYN_SCRIPT = SWEYN_REPO / "CC_connection_req_crash.py"
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "attack_surface": "Texas Instruments CC2640R2 BLE invalid connection request → crash",
    }
...
class Poc94CVE201919193SweynToothBleAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50_more"
    meta_display_id = "POC-WIRELESS-094"
    meta_poc_name   = 'CVE-2019-19193 SweynTooth Invalid Connection Request Active Validation'
    meta_cve_id     = "CVE-2019-19193"
    meta_severity   = "High"
    ...
    meta_attack_surface = "Texas Instruments CC2640R2 BLE invalid connection request → crash"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "94_Invalid_Connection_Request__TI_CC2640_B_Audit") if "VULN" in dir() else "94_Invalid_Connection_Request__TI_CC2640_B_Audit"
    ...
    _plugin = Poc94CVE201919193SweynToothBleAuditPlugin({
