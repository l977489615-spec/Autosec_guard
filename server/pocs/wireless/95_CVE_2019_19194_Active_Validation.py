#!/usr/bin/env python3
"""CVE-2019-19194 – SweynTooth BLE: Zero LTK Installation – Telink BLE zero-key LTK installation bypass.

Public PoC source: https://github.com/Matheus-Garbelini/sweyntooth_bluetooth_low_energy_attacks
  Script: Telink_zero_ltk_installation.py
...
Usage:
  python Telink_zero_ltk_installation.py /dev/ttyACM0 <target_bdaddr>
"""
...
VULN = {
    ...
    "summary": "Zero LTK Installation – Telink BLE zero-key LTK installation bypass",
...
SWEYN_SCRIPT = SWEYN_REPO / "Telink_zero_ltk_installation.py"
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "attack_surface": "Telink TLSR8 BLE SoC zero LTK installation → auth bypass",
    }
...
class Poc95CVE201919194SweynToothBleAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50_more"
    meta_display_id = "POC-WIRELESS-095"
    meta_poc_name   = 'CVE-2019-19194 SweynTooth Zero LTK Installation Active Validation'
    meta_cve_id     = "CVE-2019-19194"
    meta_severity   = "High"
    ...
    meta_attack_surface = "Telink TLSR8 BLE SoC zero LTK installation → auth bypass"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "95_Zero_LTK_Installation__Telink_BLE_zero-_Audit") if "VULN" in dir() else "95_Zero_LTK_Installation__Telink_BLE_zero-_Audit"
    ...
    _plugin = Poc95CVE201919194SweynToothBleAuditPlugin({
