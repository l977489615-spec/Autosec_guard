#!/usr/bin/env python3
"""CVE-2019-19195 – SweynTooth BLE: Invalid L2CAP Fragment – Microchip BLE invalid L2CAP fragment crash.

Public PoC source: https://github.com/Matheus-Garbelini/sweyntooth_bluetooth_low_energy_attacks
  Script: Microchip_invalid_lcap_fragment.py
...
Usage:
  python Microchip_invalid_lcap_fragment.py /dev/ttyACM0 <target_bdaddr>
"""
...
VULN = {
    ...
    "summary": "Invalid L2CAP Fragment – Microchip BLE invalid L2CAP fragment crash",
...
SWEYN_SCRIPT = SWEYN_REPO / "Microchip_invalid_lcap_fragment.py"
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "attack_surface": "Microchip ATSAMB11 BLE SoC invalid L2CAP fragment → crash",
    }
...
class Poc96CVE201919195SweynToothBleAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50_more"
    meta_display_id = "POC-WIRELESS-096"
    meta_poc_name   = 'CVE-2019-19195 SweynTooth Invalid L2CAP Fragment Active Validation'
    meta_cve_id     = "CVE-2019-19195"
    meta_severity   = "High"
    ...
    meta_attack_surface = "Microchip ATSAMB11 BLE SoC invalid L2CAP fragment → crash"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "96_Invalid_L2CAP_Fragment__Microchip_BLE_i_Audit") if "VULN" in dir() else "96_Invalid_L2CAP_Fragment__Microchip_BLE_i_Audit"
    ...
    _plugin = Poc96CVE201919195SweynToothBleAuditPlugin({
