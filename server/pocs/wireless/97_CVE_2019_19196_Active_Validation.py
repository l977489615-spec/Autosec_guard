#!/usr/bin/env python3
"""CVE-2019-19196 – SweynTooth BLE: Key Size Overflow – Telink BLE pairing key size integer overflow.

Public PoC source: https://github.com/Matheus-Garbelini/sweyntooth_bluetooth_low_energy_attacks
  Script: Telink_key_size_overflow.py
...
Usage:
  python Telink_key_size_overflow.py /dev/ttyACM0 <target_bdaddr>
"""
...
VULN = {
    ...
    "summary": "Key Size Overflow – Telink BLE pairing key size integer overflow",
...
SWEYN_SCRIPT = SWEYN_REPO / "Telink_key_size_overflow.py"
...
def _run_poc(plugin):
    ...
    evidence = {
        ...
        "attack_surface": "Telink TLSR8 BLE SoC key size overflow during pairing",
    }
...
class Poc97CVE201919196SweynToothBleAuditPlugin(IVIVulnerabilityPlugin):
    meta_generated_source = "public_poc_exp_50_more"
    meta_display_id = "POC-WIRELESS-097"
    meta_poc_name   = 'CVE-2019-19196 SweynTooth Key Size Overflow Active Validation'
    meta_cve_id     = "CVE-2019-19196"
    meta_severity   = "High"
    ...
    meta_attack_surface = "Telink TLSR8 BLE SoC key size overflow during pairing"
    is_disruptive   = True
...
if __name__ == "__main__":
    ...
    _desc = VULN.get("summary", "97_Key_Size_Overflow__Telink_BLE_pairing_k_Audit") if "VULN" in dir() else "97_Key_Size_Overflow__Telink_BLE_pairing_k_Audit"
    ...
    _plugin = Poc97CVE201919196SweynToothBleAuditPlugin({
